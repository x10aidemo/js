...
(function(){
  ...
  /* NEW BANK STYLE: Centered & Big */
  .bank{background:#ebf8ff;padding:24px;border-radius:12px;margin-bottom:24px;border:1px solid #bee3f8;text-align:center;color:#4a5568}
  .b-row { margin-bottom: 6px; font-size: 15px; }
  .b-label { font-weight: normal; opacity: 0.8; }
  .b-val { font-weight: bold; color: #000; }
  .b-acc { font-size: 22px; color: #2b6cb0; letter-spacing: 0.5px; } /* Big Account # */
  ...
  <div id="s2" class="hide">
    <div class="bank">
      ...
      <div class="b-row" style="margin:10px 0"><span class="b-label">เลขบัญชี</span><br><span class="b-val b-acc">${CONFIG.bank.acc}</span></div>
